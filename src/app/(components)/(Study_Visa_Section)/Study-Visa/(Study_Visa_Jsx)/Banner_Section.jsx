...
export default function Banner_Section() {
    return (
        <div className='  w-full bg-[#D1D1D1] grid md:grid-cols-2 items-center justify-center px-5  md:px-10 py-3'>
            ...
            <div className=' bg-white shadow-lg shadow-gray-500 h-full lg:h-[500px] w-full col-span-1 rounded-2xl p-5'>
                <h3 className='text-lg md:text-2xl font-bold text-[#2600FF] text-center '>Welcome to “study visa” department!</h3>
                ...
                <div className="flex justify-center">
                    <Button className="text-white text-xl md:text-2xl rounded-xl md:rounded-2xl h-16 bg-[#2600FF] px-10">
                        Write Me
                    </Button>
                </div>
