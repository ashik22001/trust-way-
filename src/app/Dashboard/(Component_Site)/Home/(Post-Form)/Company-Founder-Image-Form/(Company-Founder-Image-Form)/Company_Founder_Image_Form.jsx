...
export default function Company_Founder_Image_Form() {
    ...
    const handle_Form_Submit = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:3000/Company-Founder-Image-Form-Api', {
                method: "POST",
        ...
        <div className=' h-full w-full px-10 pt-10 mb-20'>
            <div className=' rounded-2xl shadow-md mx-auto items-center justify-center px-10 pb-10'>
                <div className='mx-auto items-center justify-center'>
                    <h3 className=' text-2xl font-semibold text-center py-10'>Add Founder Images</h3>
                </div>
